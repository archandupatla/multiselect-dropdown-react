    ...
    render() {
        return (
            <div className="multiSelect">
                ...
                <p>fwfwefwefwe</p>
                <input type="text" name="Search" placeholder={this.props.placeholderText?this.props.placeholderText : 'search data'} className="input-box" onChange={e => this.searchFun(e)}/>
